...
<p align="center">
  ...
  <br>
  <em>14 specialized LangGraph AI agents working together to protect you from bad clients, scams, and scope creep</em>
</p>
...
**FlagPilot** is an intelligent AI platform designed specifically for freelancers. Built on **LangGraph** and **LangChain** with **RAGFlow** knowledge retrieval, it orchestrates a team of 14 specialized AI agents that work together to:
...
### 🧠 Global Wisdom RAG
Agents don't just "guess"—they retrieve **5-star rated strategies** from a curated knowledge base and apply them to your specific situation.

### 📊 Real-Time Streaming
Watch your AI team work in real-time with CopilotKit AG-UI protocol streaming.

### 💾 Memory Persistence
Every interaction is saved in Elasticsearch. Review past analyses, track patterns, and build your personal knowledge base over time.
...
│  │   Frontend  │    │   (AG-UI Protocol Streaming)        │ │
│  └─────────────┘    └─────────────────────────────────────┘ │
│         ↕                                                    │
│  ┌─────────────────────────────────────────────────────────┐ │
│  │                  FastAPI Backend                        │ │
...
│  │  │   Plan → Execute (14 Agents) → Synthesize         │  │ │
│  │  └───────────────────────────────────────────────────┘  │ │
│  └─────────────────────────────────────────────────────────┘ │
│         ↕                    ↕                    ↕          │
│  ┌───────────┐    ┌─────────────────┐    ┌──────────────┐   │
