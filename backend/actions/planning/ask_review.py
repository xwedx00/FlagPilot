...
# from metagpt.logs import get_human_input, logger # FlagPilot Adaption: use simplified input/logger
from loguru import logger
from metagpt.schema import Message, Plan

# FlagPilot Adaption: simple async input mock
async def get_human_input(prompt: str) -> str:
    print(prompt)
    # in real usage, this should block for user input or get from API
    logger.warning("Mocking human input as 'confirm'")
    return "confirm"
